...
bool AreDofInputsVerified() {
  return supported_build::kDofInputsEmpiricallyVerified;
}
...
renodx::utils::settings::Settings settings =
    renodx::templates::settings::JoinSettings({
        ...
        renodx::templates::settings::CreateSettings({
            ...
            {{
                .value_type = renodx::utils::settings::SettingValueType::TEXT,
                .label = "This DOF shader revision is unsupported. Vanilla fallback is active.",
                .section = "Depth of Field",
                .is_visible = []() {
                  return dof_mode >= 0.5f
                         && dof_runtime_controller.GetStatus()
            ...
            {{
                .value_type = renodx::utils::settings::SettingValueType::TEXT,
                .label = "This shader revision is unsupported; Render Debug remains Off.",
                .section = "Render Debug",
                .is_visible = []() {
                  return render_debug_mode >= 0.5f
                         && render_debug_runtime_controller.GetStatus()
            ...
            {{
                .value_type = renodx::utils::settings::SettingValueType::TEXT,
                .label = "Experimental HDR core for Detroit: Become Human (Vulkan x64). Optional DLSS, DOF, motion blur, debug, and ultrawide logic lives in RenoDX Detroit Effects.",
                .section = "About",
            }},
            {{
                .value_type = renodx::utils::settings::SettingValueType::TEXT,
